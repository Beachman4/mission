...
//[[1,"CAMERAS HAVE SPOTTED ROBBERS AT A BANK!"],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
if ((_this select 0) getVariable "bank" == "bank_1") then {[[1,"CAMERAS HAVE SPOTTED ROBBERS AT THE FALLS CHURCH BANK!"],"life_fnc_broadcast",west,false] spawn life_fnc_MP;};
if ((_this select 0) getVariable "bank" == "bank_2") then {[[1,"CAMERAS HAVE SPOTTED ROBBERS AT THE BANK OF FREEDOM!"],"life_fnc_broadcast",west,false] spawn life_fnc_MP;};
if ((_this select 0) getVariable "bank" == "bank_3") then {[[1,"CAMERAS HAVE SPOTTED ROBBERS AT THE BARNSTABLE BANK!"],"life_fnc_broadcast",west,false] spawn life_fnc_MP;};
