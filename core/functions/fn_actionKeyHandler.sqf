...
if (typeOf _curTarget IN ["A3L_Wheat","A3L_Corn","A3L_Beans","A3L_Cannabis","A3L_Cotton","Ficus_Bush_1","A3L_Pumpkin","A3L_Sunflower","Oleander2","A3L_Opium"]) then {
	// It's a plant!
	
	[] call fnc_harvest;
};
if (player distance (getMarkerPos "cocain_1") < 30) then {
    [] call ffg_fnc_cocaine;
};
