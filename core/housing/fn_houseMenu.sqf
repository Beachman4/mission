...
if(!(_curTarget in life_vehicles) OR isNil {_curTarget getVariable "house_owner"}) then {
	...
	if ((typeOf _curTarget) in ["Land_Ranch_DED_Ranch_02_f", "Land_HouseDoubleAL", "Land_HouseDoubleAL2", "Land_HouseA", "Land_HouseA1", "Land_HouseA1_L", "Land_HouseB", "Land_HouseB1", "Land_HouseB1_L", "Land_HouseC_R", "Land_HouseC1_L"]) then {
