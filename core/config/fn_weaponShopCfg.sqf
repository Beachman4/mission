...
switch(_shop) do
{
        ...
        case "gas":
        {
                ["Gas Station Item Shop",[["ToolKit",nil,500],["FirstAidKit",nil,250],["ItemMap",nil,60],["ItemGPS",nil,750],["itemRadio",nil,900],["NVGoggles_OPFOR",nil,5000],["NVGoggles",nil,5000]]];
        };
        case "dai_shop":
        {
                switch(true) do
